...
export function usePlanner(currentMonth: Date) {
  ...
  const loadDemoData = () => {
    ...
    const evts: PlannerEvent[] = [
      { id:"de1",  entityId:"demo-1", date:`${m}-03`, status:"confirmed", title:"Плановый выезд",        assignee:"Иванов И.",   startTime:"09:00", endTime:"11:30" },
      { id:"de2",  entityId:"demo-1", date:`${m}-07`, status:"overdue",   title:"Проверка оборудования", assignee:"Петров А.",   startTime:"14:00", endTime:"16:00" },
      { id:"de3",  entityId:"demo-1", date:`${m}-14`, status:"pending",   title:"Обучение персонала",    assignee:"Сидорова М.", startTime:"10:00", endTime:"13:00" },
      { id:"de4",  entityId:"demo-2", date:`${m}-02`, status:"confirmed", title:"Плановый выезд",        assignee:"Козлов Р.",   startTime:"08:30", endTime:"10:00" },
      { id:"de5",  entityId:"demo-2", date:`${m}-09`, status:"pending",   title:"Замена фильтров",       assignee:"Иванов И.",   startTime:"11:00", endTime:"12:30" },
      { id:"de6",  entityId:"demo-2", date:`${m}-18`, status:"confirmed", title:"Сервисное ТО",          assignee:"Петров А.",   startTime:"15:00", endTime:"17:30" },
      { id:"de7",  entityId:"demo-3", date:`${m}-05`, status:"overdue",   title:"Проверка оборудования", assignee:"Сидорова М.", startTime:"09:00", endTime:"10:30" },
      { id:"de8",  entityId:"demo-3", date:`${m}-12`, status:"confirmed", title:"Плановый выезд",        assignee:"Козлов Р.",   startTime:"13:00", endTime:"15:00" },
      { id:"de9",  entityId:"demo-3", date:`${m}-20`, status:"pending",   title:"Замена расходников",    assignee:"Иванов И." },
      { id:"de10", entityId:"demo-4", date:`${m}-06`, status:"pending",   title:"Плановый выезд",        assignee:"Петров А.",   startTime:"08:00", endTime:"10:00" },
      { id:"de11", entityId:"demo-4", date:`${m}-15`, status:"confirmed", title:"Сервисное ТО",          assignee:"Сидорова М.", startTime:"14:00", endTime:"16:45" },
      { id:"de12", entityId:"demo-4", date:`${m}-22`, status:"overdue",   title:"Проверка оборудования", assignee:"Козлов Р.",   startTime:"10:00", endTime:"11:00" },
    ];
    setEnts(ents);
    setEvts(evts);
  };
